  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 max-w-6xl flex items-center justify-between h-16">
        {/* Logo */}
        <button className="bg-foreground text-background font-bold px-3 py-1.5 rounded-lg text-sm">
          {personal.initials}
        </button>
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <a href={personal.whatsapp} target="_blank" rel="noopener noreferrer">
            <Button className="rounded-full bg-green-500 hover:bg-green-600 text-white px-5 gap-2">
          ...
          <a href={personal.cvUrl} target="_blank" rel="noopener noreferrer">
            <Button variant="default" className="rounded-full px-5 gap-2">
              <FileText size={16} />
              Download CV
            </Button>
          </a>
